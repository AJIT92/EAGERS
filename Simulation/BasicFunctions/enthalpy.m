...
for i = 1:1:length(spec)
    ...
    switch spec{i}
        ...
        case 'H'
            ...
            hf = 218194;
        case 'C2H6'%ethane
            C =[-3.03849, 199.202, -84.9812, 11.0348, 0.30348, -90.0633, 0];
            hf = -83860.5;
        case 'C3H8'%propane
            C = [-23.1747, 363.742, -222.981, 56.253, .61164, -109.206,0];
            hf = -103855;
        case 'C4H10'%butane
            C =[-5.24343, 426.422, -257.955, 66.535, -.26994, -149.365,0];
            hf = -133218;
        case 'C5H12'%pentane
            C =[-34.9431, 576.777, -338.353, 76.8232, 1.00948, -155.348,0];
            hf = -146348;
        case 'C6H14'
            C =[-46.7786, 711.187, -438.39, 103.784, 1.23887, -176.813,0];
            hf = -166966;
        case 'CH3OH'
            C =[14.1952, 97.7218, -9.73279, -12.8461, 0.15819, -209.037,0];
            hf = -201102;
        case 'C2H5OH'
            C =[-8.87256, 282.389, -178.85, 46.3528, 0.48364, -241.239, 0];
            hf = -234441;
        case 'C6H6'%Benzene
