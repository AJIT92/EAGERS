...
% $Revision: 1.1.6.2 $  $Date: 2012/08/21 00:27:49 $

% Find SymbolSpec and remove name-value pair from inputs (if present).
defaultSymspec = [];
[symspec, inputs] = ...
   internal.map.findNameValuePair('SymbolSpec', defaultSymspec, inputs{:});
...
[displayGeometry, otherProps] = internal.map.findNameValuePair( ...
