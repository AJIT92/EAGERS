...
% $Revision: 1.1.6.4 $  $Date: 2012/07/05 16:44:23 $
...
default = 'line';
displayType = internal.map.findNameValuePair('DisplayType', default, varargin{:});
...
if numel(varargin) > 2
   propPairs = varargin(3:end);
   default = '';
   displayType = ...
      internal.map.findNameValuePair('DisplayType', default, propPairs{:});
