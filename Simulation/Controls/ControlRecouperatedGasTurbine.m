...
% Four (4) states: desired RPM, generator power, molar fuel flow and bypass valve position
global Tags 
Y = Y.*block.Scale;
...
if strcmp(string1,'Outlet')
    ...
    Out.FuelFlow = Y(3) + P_Gain(3)*FuelError*block.Scale(3);
...
elseif strcmp(string1, 'dY')
    dY = Y*0;
    dY(1) = TETerror*block.Gain(1);
    dY(2) = PowerError*block.Gain(2);
    dY(3) = FuelError*block.Gain(3);
