...
Plant.Components.FC1.Oxidant = Plant.Components.AirSource.InitialComposition; %initial oxidant composition
...
Plant.Controls.Controller.InitConditions = {'FC1.StackCathTin';'FC1.CathodeIn.IC';'FC1.Current';}; %OxidentTemp, oxidant flow rate, net current
Plant.Controls.Controller.Gain = [5e-4;1e-4;1e-3];
...
Plant.Controls.Controller.connections = {'FC1.MeasureTcathOut';'Controller.OxidantTemp';'FC1.MeasureTpen';'FC1.MeasureVoltage';};
